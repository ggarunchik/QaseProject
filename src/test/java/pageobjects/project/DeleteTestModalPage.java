...
public class DeleteTestModalPage extends BaseModalPage {
    private static final String MODAL_BUTTON_LOCATOR_XPATH = "//div[@class='ReactModalPortal']//button[contains(text(), '%s')]";

    @Override
    public boolean isModalOpened() {
        SelenideElement element =
                $(By.xpath(String.format(MODAL_BUTTON_LOCATOR_XPATH, "Delete"))).shouldBe(Condition.visible, Duration.ofSeconds(WAIT_DURATION));
